...
st.set_page_config(
    ...
    page_icon=icon,
    layout="wide",
    initial_sidebar_state="collapsed" # Na telefonie pasek domyślnie zwinięty
)

# --- 2. CSS (NAPRAWIONY DLA SAFARI) ---
st.markdown("""
    <style>
    /* USUNIĘTO UKRYWANIE HEADER - Dzięki temu strzałka > jest widoczna na Safari */
    
    /* Ukrycie stopki i menu hamburgera (opcjonalne, dla czystości) */
    #MainMenu {visibility: hidden;}
    footer {visibility: hidden;}
    
    /* Ciemny motyw wymuszony */
    .stApp {
...
# --- FUNKCJE (ZOPTYMALIZOWANE PAMIĘCIOWO DLA IPHONE) ---
def clean_df(df, n, s):
    ...
    # Tekst na kategorie (Kluczowe dla Safari)
...
with col_title:
    # Tytuł zmienia się zależnie od wybranej zakładki
